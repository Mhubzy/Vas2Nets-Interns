...
<body>
    ...
    <main class="container">
        ...
        <form action="actions/Process_Register.php" method="post">
            ...
            <input type="text" name="first" id="first"  value="<?= htmlspecialchars($old['first'] ?? '');?>" required> 

            <label for="last">Last Name</label>
            <input type="text" name="last" id="last"    value="<?= htmlspecialchars($old['last'] ?? '');?>" required>
